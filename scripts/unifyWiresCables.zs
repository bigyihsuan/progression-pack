...
// recipes.addShaped("industrialwires_tinInsulatedCoil", tinInsulatedCoil.withTag({wireLength: 4}),
//     wire(tinInsulated_x1_Cable, <ore:stickWood>));
// recipes.addShaped("industrialwires_tinInsulatedCoil_treated", tinInsulatedCoil.withTag({wireLength: 4}),
//     wire(tinInsulated_x1_Cable, <ore:stickTreatedWood>));
// // itemCopperCable
// recipes.addShaped("industrialwires_copperCoil", copperCoil.withTag({wireLength: 4}),
//     wire(copperCable, <ore:stickWood>));
// recipes.addShaped("industrialwires_copperCoil_treated", copperCoil.withTag({wireLength: 4}),
//     wire(copperCable, <ore:stickTreatedWood>));
// recipes.addShaped("industrialwires_copperInsulatedCoil", copperInsulatedCoil.withTag({wireLength: 4}),
//     wire(copperInsulated_x1_Cable, <ore:stickWood>));
// recipes.addShaped("industrialwires_copperInsulatedCoil_treated", copperInsulatedCoil.withTag({wireLength: 4}),
//     wire(copperInsulated_x1_Cable, <ore:stickTreatedWood>));
// // itemGlass
// recipes.addShaped("industrialwires_glassCoil", glassCoil.withTag({wireLength: 4}),
//     wire(glassCable, <ore:stickWood>));
// recipes.addShaped("industrialwires_glassCoil_treated", glassCoil.withTag({wireLength: 4}),
...
// recipes.addShaped("industrialwires_goldInsulatedCoil", goldInsulatedCoil.withTag({wireLength: 4}),
//     wire(goldInsulated_x2_Cable, <ore:stickWood>));
// recipes.addShaped("industrialwires_goldInsulatedCoil_treated", goldInsulatedCoil.withTag({wireLength: 4}),
